...
function FeatureCard({
  ...
  return html`
    <div
      class="bg-white/80 backdrop-blur-sm border border-gray-200 rounded-xl p-8 hover:shadow-lg transition-all @dark:bg-gray-900/80 @dark:border-gray-800"
    >
    ...
    await Layout({
          ...
          <main>
            ...
            >
              ...
              <div class="text-center max-w-3xl mx-auto">
                ...
                <div class="flex gap-4 justify-center">
                  ...
                  >
                    <span class="mr-2">› deno -A jsr:@sapling/create</span>
                    <button
                      id="copy-button"
                      class="p-2"
            ...
            <div class="py-8 px-4 text-center">
              <div class="max-w-4xl mx-auto">
                ...
                >
                  Don't believe us? This entire website is less than 300 lines
      ...
      description:
        "We don't think you should be locked into one specific framework. If you want to switch to Astro, Next, Remix, etc. you can. Just take your HTML with Tailwind styles and go.",
            ...
            <footer
              class=" text-gray-900 py-12 @dark:bg-gray-900 @dark:text-white"
            >
...
Deno.serve({
  ...
  handler: async (req) =>
    (await router.handle(req)) ?? new Response("Not Found", { status: 404 }),
});
